            ...
            <div data-src="/images/slide1.jpg">
                <div class="camera_caption fadeIn">
                    <h2>Мои последние проекты</h2>
                        ...
                        <p><a href="{{route('pages', 'works')}}" class="button">Изучить мои работы</a></p>
                </div>
            </div>
                    ...
                    <div class="grid_12">
                        <div class="block">
                            <div class="info-block">
                                <a href="https://t.me/rinakaine" rel="nofollow" >Заказать</a> Разработку у меня без скидки
                            </div>
                        ...
                        <div class="grid_8">
                            ...
                            <h2>Привет</h2>
                                <div class="wrapper">
                                    ...
                                    Енчу копилоткопилоткопилоткопилот
                                </div>
